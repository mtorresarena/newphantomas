...
const src={base:fs.readFileSync(path.join(__dirname,'index-base-31d4610.html'),'utf8'),candidate:fs.readFileSync(path.join(__dirname,'connected-inspection-b9f1a7b93ca1.html'),'utf8')};
...
const output=JSON.stringify(manifest,null,2)+'\n';fs.writeFileSync(path.join(__dirname,'segmentos-conectados-b9f1a7b93ca1.json'),output);console.log(JSON.stringify({file:'segmentos-conectados-b9f1a7b93ca1.json',sha256:hash(output),levels:levels.length,simulationSteps:0}));
