...
const src={base:fs.readFileSync(path.join(__dirname,'index-base-31d4610.html'),'utf8'),candidate:fs.readFileSync(path.join(__dirname,'connected-inspection-649512e5fb49.html'),'utf8')};
...
const output=JSON.stringify(manifest,null,2)+'\n';fs.writeFileSync(path.join(__dirname,'segmentos-conectados-649512e5fb49.json'),output);console.log(JSON.stringify({file:'segmentos-conectados-649512e5fb49.json',sha256:hash(output),levels:levels.length,simulationSteps:0}));
