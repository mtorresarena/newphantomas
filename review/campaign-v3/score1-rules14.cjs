...
const {api,route}=createGame(fs.readFileSync('review/campaign-v3/candidate-score1.html','utf8')),cases=[];
...
fs.writeFileSync('review/campaign-v3/score1-rules14.json',JSON.stringify({scope:'Isolated state fixtures, not full input routes',passed:cases.length,cases},null,2));
