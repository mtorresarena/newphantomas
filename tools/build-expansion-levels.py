...
if __name__=='__main__':
    ...
    if '// CAMPAIGN_RUNTIME_BEGIN' in s:
        raise SystemExit('This project uses campaign v3. Run tools/build-campaign.py; the v2 generator must not overwrite its puzzle maps.')
